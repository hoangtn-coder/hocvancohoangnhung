...
<head>
  ...
  <link href="<spring:url value="/resources/css/coming-soon.min.css"/>" rel="stylesheet" />
...
<body>
  ...
  <video playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
    ...
    <source src="<spring:url value="/resources/mp4/bg.mp4"/>" type="video/mp4">
  ...
  <script src="<spring:url value="/resources/js/coming-soon.min.js" />"></script>
