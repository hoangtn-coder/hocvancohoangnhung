...
<!-- Sidebar -->
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/hocvan/index">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="/hocvan/dashboard">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span>Dashboard</span></a>
      </li>
      
      <!-- <li class="nav-item">
        <a class="nav-link" href="/hocvan/admin">
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages1" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Màn hình quản lý:</h6>
            <a class="collapse-item" href="/hocvan/admin/management/news">Tin tức</a>
        </div>
      </li>
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="/hocvan/charts">
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="/hocvan/tables">
